...
INSERT INTO car (vin, make, model, year, mileage, engine, input_id, price, photo, notes, is_for_sale)
VALUES ('l1kj3b2l4hkr5b', 'Honda', 'Civic', 2000, 169000, 'V3', 2, 3500, 'https://images.unsplash.com/photo-1525609004556-c46c7d6cf023?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8Y2Fyc3xlbnwwfHwwfHw%3D&w=1000&q=80', 'It is a car', true);

INSERT INTO car (vin, make, model, year, mileage, engine, input_id, price, photo, notes, is_for_sale)
VALUES ('li1jb4i2tyb3rf', 'Chevy', 'Truck', 2005, 11, 'V8', 2, 6900, 'https://i.cbc.ca/1.5315974.1570713153!/fileImage/httpImage/image.jpg_gen/derivatives/16x9_780/ransford-lockhart-truck-explosion.jpg', 'HOT DEAL', true);
